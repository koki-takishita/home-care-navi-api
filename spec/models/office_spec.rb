...
RSpec.describe 'Officeモデルのテスト', type: :model do
  ...
  describe 'バリデーションのテスト' do
    ...
    it '画像が6枚以上ある場合、無効である' do
      invalid_images = [Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/island.png'), 'image/png')] * 6
    ...
    it '画像のファイルサイズが11MB以上ある場合、無効である' do
      invalid_image = [Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/sample_png_image_20mb.png'), 'image/png')]
